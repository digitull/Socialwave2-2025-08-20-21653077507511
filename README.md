...
- Engage: Unified inbox with prioritized replies in brand voice
- Analyze: Dashboards, variant rollups, weekly learning prompts
- Verify on ICP: Hash content (sha256), probe standard proof paths, show public proof link, export audit CSV, nightly re‑verification
